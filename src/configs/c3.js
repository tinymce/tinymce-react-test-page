(function () {
  ...
  return {
    plugins: "advtemplate typography inlinecss quickbars advlist autolink lists link image charmap preview anchor searchreplace visualblocks code fullscreen insertdatetime media table help",
    toolbar:
      "typography insertfile undo redo addtemplate inserttemplate | styles fontsizeinput | bold italic | permanentpen | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | table help",
    advcode_inline: true,
