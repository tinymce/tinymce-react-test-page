(function () {
  ...
  return {
    ...
    inline: true,
    plugins: "advlist advtemplate autolink autocorrect footnotes mergetags lists link image charmap preview anchor searchreplace visualblocks advcode fullscreen insertdatetime media table help typography inlinecss",
    toolbar:
      "typography insertfile undo redo addtemplate inserttemplate | styles fontsizeinput | bold italic | permanentpen | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | footnotes footnotesupdate | table help",
    advcode_inline: true,
