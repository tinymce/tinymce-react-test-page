(function () {
  return {
    ...
    inline: true,
    plugins: "advlist autolink autocorrect footnotes mergetags lists link image charmap preview anchor searchreplace visualblocks code fullscreen insertdatetime media table help",
    toolbar:
