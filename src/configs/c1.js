(function () {
  return {
    ...
    plugins: "advlist autolink autocorrect footnotes mergetags lists link image charmap preview anchor searchreplace visualblocks code fullscreen insertdatetime media table help wordcount typography inlinecss",
    height: 600,
    toolbar:
      "insertfile undo redo typography | styles | bold italic | wordcount | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | footnotes footnotesupdate | table help ",
    mergetags_prefix: '${',
    mergetags_suffix: '}',
    mergetags_list: [
      {
