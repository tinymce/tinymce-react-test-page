(function () {
  ...
  return {
    ...
    plugins: "advlist advtemplate autolink autocorrect footnotes mergetags lists link image charmap preview anchor searchreplace visualblocks code fullscreen insertdatetime media table help wordcount typography inlinecss",
    height: 600,
    toolbar:
      "insertfile undo redo typography addtemplate inserttemplate | styles fontsizeinput | bold italic | wordcount | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | footnotes footnotesupdate | table help ",
    advcode_inline: true,
